...
export class TodoListTodoListImageController {
  ...
  async get(
    ...
    return this.todoListRepository.todoListImage(id).get(filter);
  }
  ...
  async create(
    ...
    return this.todoListRepository.todoListImage(id).create(todoListImage);
  }
  ...
  async delete(
    ...
    return this.todoListRepository.todoListImage(id).delete(where);
  }
}
